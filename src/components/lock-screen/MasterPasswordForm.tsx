...
import { Button, Form, PasswordField, CSS, toast, keyframes } from 'shared-components'
...
export const MasterPasswordForm: React.FC = () => {
  ...
  return isMasterPasswordSaved ? <VerifyMasterPasswordForm /> : <RegisterMasterPasswordForm />
}